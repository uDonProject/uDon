...
|2주차| 서버 생성 및 개발 환경 구축 | 계정별 client/server ncloud 구축 완료 | 향후 오라클로 이전 예정 | 
|3주차| Back-end / front-end 개발 1 | 백엔드, 프론트앤드 기초 코드 작성 |  | 
|4주차| Back-end / front-end 개발 2 및 정리| 로그인 및 api 서비스 추가  | 프로젝트 종료 및 정리 | 
